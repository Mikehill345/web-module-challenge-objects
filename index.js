...
console.log(createMenuItem('ramen', 10, 'Dinner'))
console.log(createMenuItem('Chicken Nuggets', 8, 'Lunch'))
...
reviews.push({name:"Mike", rating: 5, feedback: "This place was terrible gave it a 5 just because"})
...
function getLastReview(reviews) {
    let slice = reviews.slice(-1)
     return   `${slice[0].name} gave the restaurant a ${slice[0].rating}, and their feedback was: ${slice[0].feedback}`
    } 
